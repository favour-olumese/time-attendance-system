...
class User(models.Model):
    ...
    MatricNumber = models.CharField(max_length=20, unique=True, blank=True, null=True)  # For students
    Email = models.EmailField(unique=True)
    Level = models.CharField(max_length=20, blank=True, null=True)  # For students
